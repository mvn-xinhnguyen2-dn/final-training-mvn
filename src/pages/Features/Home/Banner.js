    ...
    <Carousel autoplay className="section-banner">
      <div>
        <div className="banner-content">
          <img className="banner-img" src="https://images.hdqwalls.com/download/chicago-united-states-5k-zz-2560x1440.jpg" alt="banner" />
      ...
      <div>
        <div className="banner-content">
          <img className="banner-img" src="https://wallpapersmug.com/download/1920x1080/1f2f27/chicago-city-skycrapers-buildings.jpg" alt="banner" />
          <div className="banner-wrap-text">
